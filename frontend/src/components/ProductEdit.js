...
function ProductEdit() {
    ...
    return (
        <div className="mt-24">  
            ...
            <Link to={`/product/${productId}`} className=" bg-blue-500 hover:bg-blue-700 text-white text-center font-bold mx-5 py-2 px-4 rounded">View Product</Link>
            ...
            <form onSubmit={handleSubmit} className="my-8">
                <div className="border-2 border-gray-100 rounded-md">
                    <dl>
                        ...
                        <div className="flex items-center bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            <dt className="text-sm font-medium text-gray-500">Developers (Max. 5 developers)</dt>
                            
                            <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">{developers.map((developer, index) => (
                                <div key={index} className="flex my-2">
                                    ...
                                    />
                                    <button type="button" onClick={() => handleRemoveDeveloper(developer)} className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">
                                        Remove
                                    </button>
                                </div>
                            ))}
                            { developers.length < 5 ? 
                                <button type="button" onClick={handleAddDeveloper} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                                Add Developer
                                </button>
                                : null
                            }
                        ...
                        <div className="flex justify-end bg-white px-4 py-5 rounded-md">
                            <button type="submit" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Save post</button>
                        </div>
                    </dl>
                </div>
            </form>
